#!/usr/bin/env bash
#
# Local smoke harness for tracedao-pilot-bootstrap.
#
...
# and a tracedao-ingest `/v1/traces` endpoint. Pre-populates the hf-hub
...
#   - python3 on PATH
#   - curl on PATH
#   - target/release/tracedao-pilot-bootstrap built (or pass $SMOKE_BINARY)
...
BINARY="${SMOKE_BINARY:-$REPO_ROOT/target/release/tracedao-pilot-bootstrap}"
