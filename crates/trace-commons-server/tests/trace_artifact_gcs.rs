...
use trace_commons_server::trace_artifact_gcs::{GcsRemoteTraceArtifactProvider, InMemoryGcsObjectClient};
...
fn seed_artifact(
    ...
    >,
    GcsRemoteTraceArtifactProvider<Arc<InMemoryGcsObjectClient>>,
    trace_commons_server::trace_artifact_store::TraceArtifactPutReceipt,
    TraceArtifactScope,
) {
    let key = trace_commons_server::secrets::keychain::generate_master_key_hex();
    let crypto =
