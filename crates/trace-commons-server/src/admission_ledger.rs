...
impl PgBackend {
 ...
 AND has_column_privilege(current_user,'public.trace_accounts','created_at','UPDATE')
 AND NOT has_column_privilege(current_user,'public.trace_accounts','account_id','UPDATE')
