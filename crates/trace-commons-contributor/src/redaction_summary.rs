...
fn describe(family: &str) -> &'static str {
    match family {
        "local_path" => crate::preview_copy::REDACTION_CATEGORY_LOCAL_PATH,
        "secret" => crate::preview_copy::REDACTION_CATEGORY_SECRET,
        "privacy_filter" => crate::preview_copy::REDACTION_CATEGORY_PRIVACY_FILTER,
        "sensitive_field" => crate::preview_copy::REDACTION_CATEGORY_SENSITIVE_FIELD,
        "tool_sensitive_field" => crate::preview_copy::REDACTION_CATEGORY_TOOL_SENSITIVE_FIELD,
        RESIDUAL_PREFIX => crate::preview_copy::REDACTION_CATEGORY_RESIDUAL,
        _ => crate::preview_copy::REDACTION_CATEGORY_UNKNOWN,
    }
}
...
mod tests {
    ...
    fn a_secrets_only_session_carries_no_distinct_figure() {
        ...
        assert_eq!(
            crate::preview_copy::redaction_row_counts(removed[0].occurrences, removed[0].distinct),
            "2",
    ...
    fn an_unknown_family_is_kept_with_a_neutral_description() {
        ...
        assert_eq!(
            ...
            crate::preview_copy::REDACTION_CATEGORY_UNKNOWN
        );
    }
