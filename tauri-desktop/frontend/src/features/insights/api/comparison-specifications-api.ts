...
> {
  const response = record(
    await invokeTauri("comparison_specification_list"),
    "specification list",
  );
...
export async function previewComparisonSpecification(
  ...
  const response = record(
    await invokeTauri("comparison_specification_preview", { input }),
...
export async function saveComparisonSpecification(
  ...
  const response = record(
    await invokeTauri("comparison_specification_save", { input }),
    "specification save",
  );
...
export async function evaluateComparisonSpecification(
  ...
  const response = record(
    await invokeTauri("comparison_specification_evaluate", { id }),
