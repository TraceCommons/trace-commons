...
enum PrivateInferenceCopyFixture {
    ...
    static let complete = """
        {"destination":"DESTINATION","subtitle":"SUBTITLE",
         ...
         "credential_provider_label":"METHOD","credential_provider_github":"GITHUB",
         "credential_provider_google":"GOOGLE","credential_provider_near":"NEAR",
         ...
         "funding_what":"FUNDING-WHAT",
         "funding_manage":"FUNDING-MANAGE",
         "funding_refresh":"FUNDING-REFRESH",
         "funding_unavailable":"FUNDING-UNAVAILABLE",
