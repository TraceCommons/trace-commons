...
const stateCopy: Record<string, string> = {
  absent: "Local redaction only",
  pinned: "Pinned witness active",
  refusing_unpinned: "Submissions refused: no pin",
  refusing_pin_malformed: "Submissions refused: malformed pin",
  refusing_inference_receipts_missing:
    "Submissions refused: inference evidence missing",
  not_enrolled: "Enrollment required",
  settings_unreadable: "Submissions refused: settings unreadable",
};
  ...
  return (
    <section className="rounded-2xl border border-border bg-card/80 p-[26px] block">
      ...
      {data && (
        ...
        >
          <strong>{stateCopy[data.state] ?? "Witness state unknown"}</strong>
