...
- Analytics release: call `GET /v1/analytics/summary?release_scope=broad` after setting the production minimum cell count and verify suppressed or disabled privacy budgets fail closed with safe reason codes before any operator republishes aggregates.
