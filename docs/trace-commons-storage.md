...
6. Backfill existing file-backed data.
   ...
   - Include utility attestations, credit settlement batches, credit holds, and NEAR credit outbox rows/status in the tenant backfill so credit settlement can promote without losing pilot control-plane rows.
