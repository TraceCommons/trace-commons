...
- Security tests verify PostgreSQL RLS with `trace-commons.trace_tenant_id` across tenants, and a non-DB migration-registry regression test keeps the diagnostics table list aligned with central policy and FORCE RLS migration coverage.
