...
- Utility-worker evidence ingestion through `/v1/workers/utility-attestations`, storing policy version, source ids, canonical `sha256:<64 hex>` evidence hash, and external-ref hash without raw lab notes or trace bodies.
