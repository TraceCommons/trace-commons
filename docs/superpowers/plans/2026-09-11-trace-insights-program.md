...
| macOS comparison corrections and pilot store | [#944](https://github.com/TraceCommons/trace-commons/pull/944) fixes local Gregorian dates and saved-record identity/digest reconciliation. Explicit immutable store routing is implemented separately in commit `f44e7bc3`, awaiting stack publication. Astra cleared both changes; focused Swift tests passed 25/25. Actual app pilot and current-head CI remain required. |
