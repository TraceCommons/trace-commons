...
| Estimator experiments and evidence | [#938](https://github.com/TraceCommons/trace-commons/pull/938), followed by [#942](https://github.com/TraceCommons/trace-commons/pull/942) for the frozen runner, validated reporting, and inspectable synthetic output; [#943](https://github.com/TraceCommons/trace-commons/pull/943) adds the independently reviewed full-candidate runtime harness with measurements pending. Percentile undercoverage was found; the exact component candidate passed its frozen numerical criterion. Derived-artifact review, runtime, useful precision, and product admission remain outstanding; the candidate is test-only. |
