...
These observations address the immediate representativeness and usability concerns in [poldsam’s overall-plan review](https://github.com/TraceCommons/trace-commons/pull/870#issuecomment-5645229086). Keep every selected task in the coverage denominator, including abandoned or unsupported cases; analyzing only admitted tasks would hide whether this product serves the actual workflow.
