...
Date: 2026-05-02
Repo: `zmanian/trace-commons-server`
...
- Keep the off-chain TraceCommons server ledger authoritative for v1.
...
Files:
- `crates/trace-commons-server/src/trace_corpus_storage.rs`
- `crates/trace-commons-server/src/db/trace_corpus_pg.rs`
- `migrations/V2__trace_credit_settlement.sql`
- `crates/trace-commons-server/tests/trace_corpus_storage_contract.rs`
...
Files:
- `crates/trace-commons-server/src/near_credit.rs`
- `crates/trace-commons-server/src/lib.rs`
- `crates/trace-commons-server/tests/near_credit_contract.rs`
