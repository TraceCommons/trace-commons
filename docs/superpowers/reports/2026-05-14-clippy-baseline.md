...
- `neg_cmp_op_on_partial_ord` fires in
  `crates/trace-commons-gate-enclave/src/embedder_fastembed.rs:36` on the
...
- `cloned_ref_to_slice_refs` fires in
  `crates/trace-commons-server/tests/bakeoff_report.rs:159` — test-only,
...
`bin/trace-commons-ingest.rs` — switching to `expect_err` preserves intent
...
`type_complexity` clusters in `bin/trace-commons-ingest.rs` and the calibrate
...
`crates/trace-commons-server/src/bin/gate_calibrate/bakeoff_report.rs` and
...
| Rank | File                                                                                       | Count |
|------|--------------------------------------------------------------------------------------------|-------|
| 1    | `crates/trace-commons-server/src/bin/trace-commons-ingest.rs`                                        | 8     |
| 2    | `crates/trace-commons-server/tests/../src/bin/gate_calibrate/bakeoff_manifest.rs`               | 7     |
| 3    | `crates/trace-commons-server/tests/../src/bin/gate_calibrate/bakeoff_corpus.rs`                 | 6     |
| 4    | `crates/trace-commons-server/tests/../src/bin/pilot_bootstrap/translators.rs`                   | 5     |
| 5    | `crates/trace-commons-server/tests/../src/bin/gate_calibrate/bakeoff_report.rs`                 | 5     |
| 6    | `crates/trace-commons-server/tests/../src/bin/pilot_bootstrap/hf_dataset.rs`                    | 2     |
| 7    | `crates/trace-commons-server/tests/../src/bin/gate_calibrate/run_candidate_eval.rs`             | 2     |
| 8    | `crates/trace-commons-server/src/trace_artifact_gcs.rs`                                         | 2     |
| 9    | `crates/trace-commons-server/src/bin/pilot_bootstrap/translators.rs`                            | 2     |
| 10   | `crates/trace-commons-gate-enclave/src/vector_index.rs`                                         | 2     |

`bin/trace-commons-ingest.rs` is the known mega-file; per repo convention it
...
session). Five line edits in `bin/trace-commons-ingest.rs` plus one
