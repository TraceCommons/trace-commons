...
```
TraceArtifactStore (trait)                  crates/trace-commons-server/src/trace_artifact_store.rs:172
...
```rust
// crates/trace-commons-server/src/trace_artifact_store/kek.rs (new module)
...
```rust
// crates/trace-commons-server/src/trace_artifact_store/gcs.rs (new)
