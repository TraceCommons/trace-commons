...
be `promotable`; otherwise the settlement fails with a conflict instead of
settling ranking-derived credit. Finalized batches record the calibration run id
