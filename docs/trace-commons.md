...
lists required canary smoke checks, including `db_reconciliation_clean`,
PostgreSQL RLS readiness, and audit-chain verification, while reporting recorded, passed,
