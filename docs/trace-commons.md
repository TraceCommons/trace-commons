...
requires a positive settlement score, and appends a single idempotent
`ranking_utility` event whose external reference is
`ranking_prediction:<uuid>`.
