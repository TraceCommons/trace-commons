# Phase 3 index and credit operations

Phase 3 keeps the isolated local and test path. It adds fixed positive credit,
...
The test covers the Phase 2 recovery cases. It also covers crash boundaries 6
...
Phase 4 adds production authority, privacy, and policy-status controls.
