...
| `RevocationPropagationFailure` | A revocation effect failed and was not retried successfully | Look at `revocation_propagation_terminal_failed_vector_entries` in operational summary; check vector scheduler | Vector index unwriteable; revocation effect handler bug |
