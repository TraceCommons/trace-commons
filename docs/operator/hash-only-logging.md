...
| `CreditSettlementReversalFailed` | Credit settlement reversal on revocation failed | NEAR outbox configured? Credit ledger writable? Settlement batch list readable? | NEAR outbox dependency unavailable; settlement batch read failed |
