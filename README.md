...
claiming, and claimed replay/benchmark/ranker-training job execution for
replayable worker exports, stale export-job blockers with an admin-only stale
export-job recovery route,
PostgreSQL RLS readiness aggregate counts, safe
